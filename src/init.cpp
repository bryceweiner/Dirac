...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/dirac.conf are parsed in qt/bitcoin.cpp's main()
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _(FIRSCASE_NAME + " version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  ...
                  "  " + LOWERCASE_NAME + "d [options] help                " + _("List commands") + "\n" +
                  "  " + LOWERCASE_NAME + "d [options] help <command>      " + _("Get help for a command") + "\n";
...
int main(int argc, char* argv[])
{
    ...
    // Connect diracd signal handlers
    noui_connect();
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Dirac process is using the data directory.
    ...
    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    printf("%s version %s (%s)\n", FIRSTCASE_NAME, FormatFullVersion().c_str(), CLIENT_DATE.c_str());
    ...
    // requested to kill dirac-qt during the last operation. If so, exit.
